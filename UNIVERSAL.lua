...
-- UI Setup (not wrapped in a function)
...
local originalCleanup = cleanup -- Store original ESP cleanup
local function combinedCleanup()
    originalCleanup() -- Call ESP cleanup
    cleanupAimbot() -- Call Aimbot cleanup
end
